...
Route::group(['middleware' => ['auth:web', 'roles'], 'roles' => ['AUTHORIZED'], 'prefix' => ''], function () {
    ...
    Route::group(['prefix' => 'task'], function () {
        ...
        // test
        Route::get('/task_schedule', 'Task\TaskController@index_schedule_testing')->name('task_schedule_testing');
        ...
        Route::get('/zip', 'Task\TaskController@zipfile')->name('exportzip.zip');
        ...
        Route::any('/delete_task_all', 'Task\TaskController@delete_task_checkbox')->name("task_delete_all");
        Route::any('/delete_task_schedule/{id_task}', 'Task\TaskController@delete_task_schedule')->name('taskSchedule.delete');
        Route::any('/delete_task_schedule_all', 'Task\TaskController@delete_task_schedule_checkbox')->name("task_delete_schedule_all");
    ...
    Route::group(['prefix' => 'waiting_approval'], function () {
        ...
        // Route::post('/detail/{id_task}', 'WaitingApprovalController@rejectNote')->name('updateNote');
    ...
    Route::group(['prefix' => 'setup'], function () {
        ...
        Route::group(['prefix' => 'userpermission'], function () {
            ...
            // verif. user atau account
            // Route::any('/verifikasi-user', 'Setup\UserPermission\UserPermissionController@verifikasiUser');
            Route::any('/verifikasi-user/{id}', 'Setup\UserPermission\UserPermissionController@verifikasiUser')->name('verifikasi_user');
        ...
        Route::get('/cir-upload', 'CirController@index');
        Route::get('/cir-upload/create', 'CirController@create');
        Route::Post('/cir-upload/create', 'CirController@create_cir');
        ...
        Route::group(['prefix' => 'Customization/{id_type}'], function () {
            ...
            // PLM
            Route::get('/checklistPLM', 'Setup\Customization\ChecklistController@indexPlm')->name('index.plm');
            Route::any('/getChecklistPLM', 'Setup\Customization\ChecklistController@getDataPlm')->name('getPlm');
            ...
            // Permanenisasi
            Route::get('/rootCaused', 'Setup\Customization\rootCausedController@index')->name('rootCaused');
            Route::post('/new_rootCaused', 'Setup\Customization\rootCausedController@store')->name('rootCaused.store');
            Route::get('/getRootCaused', 'Setup\Customization\rootCausedController@getData');
            Route::post('/update_rootCaused', 'Setup\Customization\rootCausedController@update');
            Route::any('/delete_rootCaused/{id_caused}', 'Setup\Customization\rootCausedController@destroy')->name('rootCasued.destroy');
        });
        ...
        Route::group(['prefix' => 'servicedesk'], function () {
            ...
            Route::group(['prefix' => 'site'], function () {
                ...
                Route::Post('/addSiteCategory', 'Setup\Servicedesk\SiteController@newSiteCategory')->name('siteCategories.add');
...
// cir upload
Route::get('/cir-upload', 'CirController@index')->name('cir_upload')->middleware('technician');
Route::get('/cir-upload/create', 'CirController@create')->name('cir_index');
Route::post('/cir-upload/create', 'CirController@addCirUpload')->name('upload.files');
Route::any('/cir-upload/detail/{id_task}', 'CirController@detail_cir')->name('cir.detail');
Route::any('/cir-upload/update/{id_task}', 'CirController@updateData')->name('cir.update');
Route::get('/trend-fo-cut', 'CirController@trendFoCut')->name('foCut');

// Route::any('/cir-upload/update/{id_task}', 'CirController@uploadData')->name('cir.upload');
