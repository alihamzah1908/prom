...
class TotalCapacityController extends Controller
{
    public function index(Request $request)
    {
        return view('setup.aktivasi_layanan.totalcapacity');
    }
    
    public function new_totalcapacity(Request $r)
    {
        $user = Auth::user();
        if(!$user){
     ...
     public function remove_totalcapacity(Request $r, $id_total_capacity){
        $result = [];
        $result["status"] = false;
        $result["message"] = "";
    ...
    public function edit_totalcapacity(Request $r)
    {
    ...
    public function getTotalcapacity(Request $r)
    {
