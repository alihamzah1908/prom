...
class HomeController extends Controller
{
    ...
    {
        return view('dashboard.trouble');
    }

    public function incident()
    {
        return view('dashboard.incident');
    }
    ...
    public function taskmon()
    {
        return view('dashboard.taskmon');
    }
