...
class Task extends Model
{
    ...
    public function siteA(){
        return $this->hasOne('\App\Model\Site', 'site_id', 'id_site_a' );
    }

    public function technician(){
        return $this->hasOne('\App\Model\Technician', 'id_technician', 'id_technician' );
    }

    public function taskDetail(){
        return $this->hasOne('\App\Model\TaskDetail', 'id_task', 'id_task');
    }
}
