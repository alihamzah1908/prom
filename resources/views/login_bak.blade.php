				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<div class="header">
								<h3 class="lead text-primary"><b>User Log In</b></h3>
							</div>
                            ...
                            @csrf
								...
								<div class="form-group ">
									...
									<input type="password" class="form-control rounded" id="signin-password" placeholder="Masukan Password Anda" required name="password">
                                </div>
                                <div class="bottom">
