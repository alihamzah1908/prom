<?php
    $r = request();
    $data = \App\Model\PermitLetter::where('id_permit_letter', $r->id)->first();
            ...
            <div class="pcs-template-body border-2" style="padding:0.5rem; width:100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:50%;" class="text-align-right v-top">
                                <span class="pcs-entity-title">PERMIT LETTER</span><br>
                ...
                <div class="border-1 w100" style="padding:1rem">
                    ...
                    <table class="w100" style="padding:0.5rem">
                        <tbody>
                            <tr style="height:3%">
                                <td class="w10"><b>Nama Pemohon</b></td>
                                <td class="w90"><b>: {{$data->pemohon}}</b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Nama Instansi</b></td>
                                <td class="w75"><b>: {{$data->instansi}}</b></td>
                            </tr>
                            <tr style="height:3%;">
                                <td class="w25"><b>Departemen</b></td>
                                <td class="w75"><b>: {{$data->departemen}}</b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Nama Atasan</b></td>
                                <td class="w75"><b>: {{$data->atasan}}</b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Nomor Telepon</b></td>
                                <td class="w75"><b>: {{$data->nomor_telepon}}</b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Jumlah Pengunjung</b></td>
                                <td class="w75"><b>: {{$data->jumlah_pengunjung}} Orang</b></td>
                            </tr>
                            <tr style="height:3%">
                                <td style="width: 25%"><b></b></td>
                            </tr>
                            <tr style="height:3%">
                                <td style="width: 25%"><b>Nama Pengunjung</b></td>
                                <td style="width:75%">
                                    <table style="width:100%">
                                        <tbody>
                                            @foreach($data->pengunjung->take(1) as $pengunjung)
                                            <tr>
                                               <td style="width:2%; text-align:right">
                                                   {{++$p}}
                                               </td>
                                               <td class="w35">
                                                   <b>{{$pengunjung->nama_pengunjung}}</b>
                                               </td> 
                                               <td style="width:8%; text-align:right">
                                                   No. Telp
                                               </td>
                                               <td class="w35">
                                                   <b>{{$pengunjung->telp_pengunjung}}</b>
                                               </td> 
                                            </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <tr style="height:3%">
                                ...
                                <td style="width:75%">
                                    <table style="width:100%">
                                        <tbody>
                                            @foreach($data->pengunjung->skip(1) as $pengunjung)
                                            <tr>
                                               <td style="width:2%; text-align:right">
                                                   {{++$p}}
                                               </td>
                            ...
                            <tr style="height:3%">
                                <td class="w25"><b>No. ID Pengunjung</b></td>
                                <td class="w75"><b>:  </b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Tanggal Pengajuan</b></td>
                                <td class="w75"><b>: {{$data->tanggal_pengajuan}} </b></td>
                            </tr>
                            <tr style="height:3%">
                                <td class="w25"><b>Tanggal Berlaku</b></td>
                                <td style="width:75%">
                                    <b style="border-bottom:1px solid #000">
                                    <table style="width:100%;">
                                        <tbody>
                                            <tr>
                                               <td style="width:35%;">
                                                   <b> {{$data->tanggal_berlaku}}</b>
                                               </td> 
                                               <td style="width:5%; text-align:center">
                                                   s.d.
                                               </td>
                                               <td style="width:35%;">
                                                   <b>{{$data->tanggal_berlaku_sd}}</b>
                                               </td> 
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <tr style="height:10%; border-bottom:1px solid #000;">
                            <td style="width:50%; text-align:left">
                                <div style="text-align:center">
                                    <b>Pemohon</b>
                                    <div style="width:80.00px;height:80.00px;">
