    ...
    <div class="row">
        <div class="col-md-5">
            <div class="form-group">
                ...
                <select class="form-control select2 select_category" style="width: 100%;" disabled name="id_category">
        ...
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="total_hari_kerja" disabled 
            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="down_start" id="down_start" disabled 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="down_end" id="down_end" disabled 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="total_waktu_kerja" disabled 
