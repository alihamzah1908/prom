...
<div class="card-body text-dark">
    <div class="row">
        <div class="col-md-12" hidden>
            ...
            <div class="row pilihan_jadwal" style="padding: 1rem 1rem 0rem 0rem !important;">
                <div class="col-lg-8">
                    ...
                    <div class="col-md-5x">
                        ...
                        @if($task_detail->request_complete_time != '')
                            <div class="form-group row">
                                ...
                                @if(old('request_complete_time')) value="{{old('request_complete_time')}}" @elseif($task_detail->request_complete_time) value="{{date('Y-m-d', strtotime($task_detail->request_complete_time))}}" @else value="{{date('Y-m-d')}}"
