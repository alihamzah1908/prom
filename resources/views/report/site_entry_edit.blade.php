...
<div class="row mb-2">
    <div class="col-sm-6">
        <h3 class="m-0 text-dark"><strong>Site Entry Reports</strong></h3>
    </div>
</div>
@endsection
@section('content')
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-10">
                <h3 class="card-title"><a href="/report/site_entry"><i class="fa fa-arrow-left text-gray"></i></a><strong>Reports</strong></h3>
            </div>
            <div class="col-md-2">
                <a href="/report/site_entry?id={{isset($report_columns->id)?$report_columns->id:''}}" class="btn btn-sm btn-success pull-right">Report Query</a>
            </div>
        </div>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
        <a href="/report/site_entry" class="btn btn-md btn-default">BACK</a>
