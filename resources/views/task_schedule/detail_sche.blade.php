...
<div class="card col-md-12" style="border-top: 2px solid #ddd; margin-left: 0px; padding:0.1rem; margin-bottom: 2px !important; border-bottom-left-radius: 0; border-bottom-right-radius: 0;">
    <ul class="nav nav-pills row text-center col-md-10" style="margin-left: 0;margin-right: 0;">
        <!-- <li class="nav-item col-md-2"><a style="border-radius:0" class="nav-link" href="#detail" data-toggle="tab">Detail</a></li> -->
        @if(!$technician)
        <!-- <li class="nav-item col-md-2"><a style="border-radius:0" class="nav-link" href="#log" data-toggle="tab">Log</a></li> -->
        <li class="nav-item col-md-2"><a style="border-radius:0" class="active nav-link" href="#edit" data-toggle="tab">Edit</a></li>
        @endif
    ...
    <div class="card-body" style="background-color: #f1f1f1;">
        <div class="tab-content">
            <div class="tab-pane" id="detail">
                @include('task_schedule.task_detail_sche')
            </div>
            @if(!$technician)
            <div class="active tab-pane" id="edit">
                <form method="POST" action="/task/update_task_schedule/{{$task->id_task}}" enctype="multipart/form-data"> 
                @csrf
                    @include('task_schedule.task_edit')
