...
<div class="card-body text-dark">
    ...
    <div class="row" style="padding: 1rem 1rem 0rem 0rem !important;">
        <div class="col-lg-8">
            <input type="text" id="Txt_Date" class="form-control" name="jadwalku" value="{{$task->waktus}}" placeholder="Choose Date" readonly style="cursor: pointer;">
        </div>
        <div class="col-lg-2">
            <select class="form-control" style="width: 100%;" name="jam">
                <option value="" selected disabled>-- Select Hours --</option>
                <option value="01" {{  ($task->jam == "1" ? ' selected' : '') }}>01</option>
                <option value="02" {{  ($task->jam == "2" ? ' selected' : '') }}>02</option>
                <option value="03" {{  ($task->jam == "3" ? ' selected' : '') }}>03</option>
                <option value="04" {{  ($task->jam == "4" ? ' selected' : '') }}>04</option>
                <option value="05" {{  ($task->jam == "5" ? ' selected' : '') }}>05</option>
                <option value="06" {{  ($task->jam == "6" ? ' selected' : '') }}>06</option>
                <option value="07" {{  ($task->jam == "7" ? ' selected' : '') }}>07</option>
                <option value="08" {{  ($task->jam == "8" ? ' selected' : '') }}>08</option>
                <option value="09" {{  ($task->jam == "9" ? ' selected' : '') }}>09</option>
                ...
                <option value="00" {{  ($task->jam == "0" ? ' selected' : '') }}>00</option>
            </select>
        </div>
        <div class="col-lg-2">
            <select class="form-control" style="width: 100%;" name="menit">
                <option value="" selected disabled>-- Select Minute --</option>
                <option value="01" {{  ($task->menit == "1" ? ' selected' : '') }}>01</option>
                <option value="02" {{  ($task->menit == "2" ? ' selected' : '') }}>02</option>
                <option value="03" {{  ($task->menit == "3" ? ' selected' : '') }}>03</option>
                <option value="04" {{  ($task->menit == "4" ? ' selected' : '') }}>04</option>
                <option value="05" {{  ($task->menit == "5" ? ' selected' : '') }}>05</option>
                <option value="06" {{  ($task->menit == "6" ? ' selected' : '') }}>06</option>
                <option value="07" {{  ($task->menit == "7" ? ' selected' : '') }}>07</option>
                <option value="08" {{  ($task->menit == "8" ? ' selected' : '') }}>08</option>
                <option value="09" {{  ($task->menit == "9" ? ' selected' : '') }}>09</option>
                ...
                <option value="00" {{  ($task->menit == "0" ? ' selected' : '') }}>00</option>
            </select><br>
        </div>
        <script>
        $("#Txt_Date").datepicker({
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                if(!$id_checklist_category){
                    $id_checklist_category = $task->id_checklist_category;
                }
                if(!$id_checklist_category){
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            @if(old('checklist_periode') == $per->id_periode || $task->checklist_periode == $per->id_periode) checked @endif>
    ...
    <br> 
    <!--<hr>-->
    <p class="judul1">Basic Information dari </p>
    <div class="row">
